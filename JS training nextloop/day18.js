// localStorage, sessionStorage, Geolocation, ES6 concepts such as (let/const, Template Literals, Arrow Functions), HTML5 Canvas & task. 
...
// -We can remove data from local storage with localStorage.removeItem(key);
// -All data from local storage can be cleared with the localStorage.clear() method. 

// localStorage.setItem("fname","Jack");
// localStorage.setItem("lname","Jain");
...
// sessionStorage.setItem("fname","Jack");
...
// Q.1,2 & 3--
// Add a item to localstorage & sessionstorage called counter -
// Increment the counter item whenever user visits the page -
// Display the counter value in the html doc -

// function counter() {
//     var n = localStorage.getItem('on_load_counter');  //for local storage
//     if (n === null) {
//         n = 0;
//     } else {
//         n++;
...
//     var n = sessionStorage.getItem('on_load_counter'); //for session storage
//     if (n === null) {
//         n = 1;
//     } else {
//         n++;
...
// -We can user navigator.geolocation.clearWatch() method to stops the watchPosition() method. 
